...
public class Marine implements Parcelable
{
 ...
 //TODO::location
    ...
    public Marine(String name, ArrayList<Worker> workers, String objectID, String email,
    ...
    public static final Creator<Marine> CREATOR = new Creator<Marine>() {
        @Override
        public Marine createFromParcel(Parcel in) {
            return new Marine(in);
        }

        @Override
        public Marine[] newArray(int size) {
            return new Marine[size];
        }
    };
